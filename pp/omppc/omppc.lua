...
Beatmap.STRAIN_STEP = 350
Beatmap.DECAY_WEIGHT = 0.875
...
Calculator.computeStrainValue = function(self)
	...
	self.strainValue = math.pow(5 * math.max(1, self.beatmap:getStarRate() / 0.0825) - 4, 3) / 110000
...
Calculator.computeAccValue = function(self)
	...
	self.accValue = math.max(0, 0.2 - ((hitWindow300 - 34) * 0.006667)) * self.strainValue * (math.min(1.15, math.pow(self.beatmap.noteCount / 1500, 0.3)))
end
